(function () {
  ...
  t.brand = {}
  t.brand.lg = '数据库在线统计与画图工具'
  t.brand.mini = '生物学数据分析'

  t.add = '新增'
  t.addOption = '新增选项'
  t.delete = '删除'
  t.deleteBatch = '删除'
  t.completeDelete = '彻底删除'
  t.update = '修改'
  t.query = '查询'
  t.export = '导出'
  t.handle = '操作'
  ...
  t.login.captcha = '验证码'
  t.login.demo = '在线演示'
  t.login.copyright = 'high哥工作室'

  t.home = {}
  t.home.sysInfo = {}
  t.home.sysInfo.name = '系统名称'
  t.home.sysInfo.nameVal = '稿件处理'
  ...
  t.oss.aliyunDomainTips = '阿里云绑定的域名，如：http://cdn.highy.io'
  ...
  t.oss.localDomainTips = '绑定的域名，如：http://cdn.highy.io'
  t.oss.fastdfsDomain = '域名'
  t.oss.fastdfsDomainTips = '绑定的域名，如：http://cdn.highy.io'
