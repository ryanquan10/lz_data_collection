package com.highy.modules.plot.service.impl;
...
@Service
public class VennRenderService implements IRenderService {

    @Override
    public RestResponse render(HttpServletRequest request, AnalysisDataMessage message) {
...
//				            response.setBizContent("Cannot load R");
    ...
    @Override
    public RestResponse renderWithFile(HttpServletRequest request, MultipartFile dataFile, AnalysisDataMessage message) {
        Map parameterMap=request.getParameterMap();
