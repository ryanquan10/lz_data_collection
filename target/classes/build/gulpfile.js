...
var theme            = {}
var themeList        = require('./element-ui/config.js').filter(item => !item.hasBuild)
var styleFileDir     = './scss'
var styleFileDirTemp = `${styleFileDir}-temp`
var themeFileDir     = '../statics/element-theme'
...
gulp.task('mixins', () => {
  return gulp.src(['../statics/mixins/**/*.js'])
